...
namespace MatrizHabilidadeCore.Migrations
{
    ...
    [Migration("20220102200649_CreatingRoles")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "MASTER",
                            ConcurrencyStamp = "94fc8159-4b1f-4c72-adb6-45d2e3a5c3e4",
                            Name = "Master",
                        ...
                        {
                            Id = "ADMINISTRADOR",
                            ConcurrencyStamp = "3cdd034c-5f32-4215-a5ca-7af461d49a35",
                            Name = "Administrador",
                        ...
                        {
                            Id = "COORDENADOR",
                            ConcurrencyStamp = "e6705d01-9598-4365-9fdc-eb0667e23eee",
                            Name = "Coordenador",
                        ...
                        {
                            Id = "FUNCIONARIO",
                            ConcurrencyStamp = "f0b48c09-75bc-48c8-af82-9a8d42537e70",
                            Name = "Funcionario",
                        ...
                        {
                            Id = "NONE",
                            ConcurrencyStamp = "648eadd8-a130-4425-9ce7-97ec8b83b403",
                            Name = "None",
                            NormalizedName = "NONE"
                        });
                });
            ...
            modelBuilder.Entity("MatrizHabilidadeDatabase.Models.Usuario", b =>
                {
                    b.HasOne("MatrizHabilidadeDatabase.Models.Colaborador", "Colaborador")
                        .WithOne("Usuarios")
                        .HasForeignKey("MatrizHabilidadeDatabase.Models.Usuario", "ColaboradorId");

                    b.HasOne("MatrizHabilidadeDatabase.Models.Coordenador", "Coordenador")
                        .WithOne("Usuarios")
                        .HasForeignKey("MatrizHabilidadeDatabase.Models.Usuario", "CoordenadorId");
